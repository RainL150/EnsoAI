...
export const zhTranslations: Record<string, string> = {
  ...
  'Remote Sharing': '远程共享',
  // Skills v2 — only keys not already defined elsewhere in this file
  'Cross-CLI skill management (Claude + Codex)': '跨 CLI 技能管理（Claude + Codex）',
  Sources: '来源',
  Sync: '同步',
  'Sync complete': '同步完成',
  'Skill uninstalled': '技能已卸载',
  'Failed to load skills': '加载技能失败',
  'No skills installed yet': '尚未安装任何技能',
  'Add a source under "Sources" and install from "Browse".':
    '到「来源」添加 source，再从「远程」浏览安装。',
  'skill update(s) available': '个技能有更新',
  'Install skill': '安装技能',
  'skill(s) from enabled sources': '个技能可装（来自已启用的 source）',
  'No skills found. Enable sources under "Sources" and refresh.':
    '没有可装的技能。请在「来源」启用至少一个 source 并刷新。',
  'source(s)': '个来源',
  'Add source': '添加来源',
  'No sources configured': '尚未配置任何来源',
  'Add a Git repo URL or a local skill directory.': '添加 Git 仓库 URL 或本地 skill 目录。',
  'Source removed': '来源已删除',
  'Source added': '来源已添加',
  'Add skill source': '添加技能来源',
  'Git repository': 'Git 仓库',
  'Local directory': '本地目录',
  'My skill source': '我的技能来源',
  'Source dir': '来源目录',
  '"." = single-skill repo; "skills" = directory containing many.':
    '"." 表示仓库根目录即一个 skill；"skills" 表示仓库下含多个 skill 的目录。',
  'Local path': '本地路径',
  'Browse...': '浏览…',
  'Point at a dir containing SKILL.md or a parent dir of many skills.':
    '指向含 SKILL.md 的目录，或含多个子 skill 的父目录。',
  'Name is required': '名称必填',
  'Invalid Git URL': 'Git URL 格式无效',
  'Local path is required': '本地路径必填',
  Mode: '模式',
  'Symlink (recommended)': '符号链接（推荐）',
  'Symlink: lightweight, edits propagate instantly.': '符号链接：轻量，编辑实时同步。',
  'Copy: standalone, decoupled from source updates.': '拷贝：独立，与来源更新解耦。',
  'Pick at least one target': '至少选择一个目标',
